/* A modified version of gui.js that serves our needs
...
IDE_Morph.prototype.setDefaultDesign = function () {
    ...
    SpriteMorph.prototype.paletteColor = new Color(16, 22, 44);
...
IDE_Morph.prototype.createLogo = function () {
    ...
    this.logo = new Morph();
    //bags_logo_sm.png is a custom image created for Bags
    this.logo.texture = 'bags_logo_sm.png';
...
IDE_Morph.prototype.createSpriteBar = function () {
    ...
    tab = new TabMorph(
        tabColors,
        null, // target
        function () {tabBar.tabTo('query2'); },
        localize('Query 2'), // label
        function () {  // query
            return myself.currentTab === 'query2';
        }
    );
    tab.padding = 3;
    tab.corner = tabCorner;
    ...
    tab = new TabMorph(
        tabColors,
        null, // target
        function () {tabBar.tabTo('query3'); },
        localize('Query 3'), // label
        function () {  // query
            return myself.currentTab === 'query3';
        }
    );
    tab.padding = 3;
    tab.corner = tabCorner;
    ...
    tab = new TabMorph(
        tabColors,
        null, // target
        function () {tabBar.tabTo('query4'); },
        localize('Query 4'), // label
        function () {  // query
            return myself.currentTab === 'query4';
        }
    );
    tab.padding = 3;
    tab.corner = tabCorner;
...
IDE_Morph.prototype.createSpriteEditor = function () {
    ...
    if (this.currentTab === 'scripts') {
    ...
    } /* else if (this.currentTab === 'query2') 
        query2.isDraggable = false;
        query2.color = this.groupColor;
        query2.texture = this.scriptsPaneTexture;
        ...
        query2.scrollFrame = this.spriteEditor;
        this.add(this.spriteEditor);
        this.spriteEditor.scrollX(this.spriteEditor.padding);
        this.spriteEditor.scrollY(this.spriteEditor.padding); 
    } */
...
//            this.stage.setScale(this.isSmallStage ? 0.5 : 1);
        ...
        // spriteBar
        //Made a change from this.stage.left() to this.right() to eliminate blank space
        this.spriteBar.setPosition(this.logo.bottomRight().add(padding));
        this.spriteBar.setExtent(new Point(
            Math.max(0, this.right() - padding - this.spriteBar.left()),
...
//Tweaked the about message so that it talks about Bags
IDE_Morph.prototype.aboutSnap = function () {
    var dlg, aboutTxt, noticeTxt, creditsTxt, versions = '', translations,
        module, btn1, btn2, btn3, btn4, licenseBtn, translatorsBtn,
        world = this.world();

    aboutTxt = 'Bags 1.0\nBuild Your Own Relations\n\n--- alpha ---\n\n'
        + 'Bags is a relational alegbra educational tool\n'
        + 'developed at James Madison University.\n\n'

        + 'Copyright \u24B8 2013 Jason Gorman, Sebastian Gsell,\n'
        + 'and Chris Mayfield <mayfiecs@jmu.edu>.\n\n'
        
        + 'Snap! Copyright \u24B8 2013 Jens M\u00F6nig and '
        + 'Brian Harvey\n'
